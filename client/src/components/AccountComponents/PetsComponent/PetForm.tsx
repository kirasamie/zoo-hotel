...
export default function PetForm(): JSX.Element {
  ...
  return (
    <form className={styles.form}>
      {pet ? <h2>Редактирование карточки {pet?.petName}</h2> : <h2>Добавление карточки питомца</h2>}
      <div className={styles.inputsContainer}>
        <div className={styles.input}>
          <FormControl>
            <FormLabel id="demo-controlled-radio-buttons-group">Вид животного</FormLabel>
        ...
        <div className={styles.input}>
          <TextField fullWidth id="outlined-multiline-flexible" label="Кличка" name="petName" value={inputs.petName} onChange={(e) => handlerChange(e)} multiline maxRows={4} />
        </div>
        <div className={styles.input}>
          <TextField fullWidth id="outlined-multiline-flexible" name="petBreed" value={inputs.petBreed} onChange={(e) => handlerChange(e)} label="Порода" multiline maxRows={4} />
        </div>
        <div className={styles.input}>
          <FormControl>
        ...
        <div className={styles.input}>
          <TextField fullWidth id="outlined-multiline-flexible" name="petAge" value={inputs.petAge} onChange={(e) => handlerChange(e)} label="Возраст в годах" multiline maxRows={4} />
        </div>
        <div className={styles.input}>
          <FormControl>
            <FormLabel id="demo-controlled-radio-buttons-group">Стерилизован(-a)</FormLabel>
        ...
        <div className={styles.input}>
          <TextField fullWidth multiline id="outlined-basic" label="Расскажите о питомце" variant="outlined" value={inputs.petAbout} onChange={(e) => handlerChange(e)} name="petAbout" rows={4} />
        </div>
