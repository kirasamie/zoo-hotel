...
export default function PetMenu(): JSX.Element {
  ...
  return (
    <div className={styles.menu}>
      <Link className={styles.link} style={{ textDecoration: 'none' }} to='/account/pets/new'>
      ...
      {pets.map((pet) => (
        <Link className={styles.link} style={{ textDecoration: 'none' }} key={pet.id} to={`/account/pets/${pet.id}`}>
          <GlassWrapper width='100%'>
